...
#Preview("Sign up") {
  SignUpFlow(model: SignUpFeature().withAnchor())
}
...
#Preview("Basics") {
  NavigationStack {
    BasicsStep(model: BasicsFeature().withAnchor())
  }
}
...
#Preview("Personal info") {
  NavigationStack {
    PersonalInfoStep(model: PersonalInfoFeature().withAnchor())
  }
}
...
#Preview("Topics") {
  NavigationStack {
    TopicsStep(model: TopicsFeature().withAnchor())
  }
}
...
#Preview("Summary") {
  NavigationStack {
    SummaryStep(model: SummaryFeature().withAnchor {
